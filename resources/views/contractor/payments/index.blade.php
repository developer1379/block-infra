    ...
    <div class="p-6 space-y-8 animate-fade-in">
        ...
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            ...
            <a href="{{ route('contractor.payments.create') }}" 
                class="w-full lg:w-auto inline-flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-black px-6 py-3.5 rounded-2xl transition-all shadow-xl shadow-emerald-100 transform active:scale-95">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-white p-6 rounded-[2.5rem] border border-gray-100 shadow-sm group hover:border-emerald-200 transition-all">
            ...
            <div class="bg-white p-6 rounded-[2.5rem] border border-gray-100 shadow-sm group hover:border-indigo-200 transition-all">
                <div class="flex items-center gap-5">
            ...
            <div class="bg-white p-6 rounded-[2.5rem] border border-gray-100 shadow-sm group hover:border-amber-200 transition-all">
                <div class="flex items-center gap-5">
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-gray-50/50 border-b border-gray-50">
                            ...
                            <th class="px-8 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest text-center">{{ __('Method') }}</th>
                            <th class="px-8 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest">{{ __('Period') }}</th>
                            <th class="px-8 py-5 text-[10px] font-black text-gray-400 uppercase tracking-widest">{{ __('Reference') }}</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-50">
                        @forelse ($payments as $payment)
                            <tr class="hover:bg-gray-50/80 transition-all group">
                                ...
                                <td class="px-8 py-6 font-mono text-[10px] text-gray-400">
