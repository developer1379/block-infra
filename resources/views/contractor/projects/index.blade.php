        ...
        @if (auth()->user()->hasRole('contractor'))
            ...
            <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6 rounded-r-lg shadow-sm">
                <div class="flex items-center gap-3">
                    ...
                    <p class="text-sm text-blue-700 font-medium">Projects shown below are based on your assigned
                        categories.
                    </p>
                </div>
            </div>
                ...
                <div
                    ...
                    <div class="p-5 pt-2 flex-1">
                        ...
                        <div
                            ...
                            <div>
                                <p class="text-[10px] text-slate-400 font-bold uppercase leading-none mb-1">Est. Budget
                                </p>
