<x-contractor-layout>
    <div class="p-6 space-y-8 animate-fade-in">
        ...
        <div class="flex flex-col md:flex-row md:items-center gap-5 bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
            ...
            <div>
                <h1 class="text-3xl font-black text-gray-900 tracking-tight">{{ __('Edit Worker Profile') }}</h1>
                <p class="text-gray-500 text-sm font-medium">{{ __('Update information for') }} <span class="text-indigo-600 font-bold">{{ $worker->name }}</span></p>
            </div>
        </div>
