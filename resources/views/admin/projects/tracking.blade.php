                                ...
                                <div class="relative pl-8 group">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        @if ($update->report_description)
                                            <div class="text-[11px] text-slate-600 bg-slate-50/50 p-3 rounded-xl border border-slate-100 leading-relaxed italic">
                                ...
                                @foreach($logs as $log)
                                    <tr class="hover:bg-slate-50/40 transition-colors">
                                        ...
                                        <td class="px-6 py-3.5">
                                            ...
                                            @if($log->notes)
                                                <div class="text-[9px] text-slate-400 italic max-w-[150px] truncate mt-0.5" title="{{ $log->notes }}">{{ $log->notes }}</div>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
