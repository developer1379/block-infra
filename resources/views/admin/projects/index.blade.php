            ...
            <div
                ...
                <div
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        {{-- Track (Admin Only) --}}
                        @if (auth()->user()->hasRole('admin'))
                            <a href="{{ route('admin.projects.payments', $project->id) }}"
                                class="w-8 h-8 rounded-lg bg-white border border-slate-200 text-green-600 hover:bg-green-50 hover:border-green-200 flex items-center justify-center transition-all shadow-sm"
                                title="Project Finances & Payments">
