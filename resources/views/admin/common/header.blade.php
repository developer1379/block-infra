    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="hidden md:flex relative group">
                <span
                    class="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 group-hover:text-primary transition-colors">
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <div x-show="open" x-transition.origin.top.right x-cloak
                    ...
                    <div class="max-h-64 overflow-y-auto">
                        <a href="#"
                            class="flex items-start gap-3 px-4 py-3 hover:bg-slate-50 transition-colors border-b border-gray-50">
                            <div
                    ...
                    <a href="#"
                        class="block text-center py-2 text-xs font-semibold text-primary hover:bg-slate-50">View All</a>
                </div>
            </div>
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <div x-show="open" x-transition.origin.top.right x-cloak
                    ...
                    <a href="#"
                        class="flex items-center gap-2 px-4 py-2 text-sm text-slate-600 hover:bg-primary-light hover:text-primary">
