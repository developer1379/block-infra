    ...
    <div class="max-w-4xl mx-auto space-y-8 animate-fade-in">
        ...
        <div class="flex items-center justify-between bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
            <div class="flex items-center gap-5">
                ...
                <div>
                    <h1 class="text-2xl font-black text-slate-800 tracking-tight">Define Raw Material</h1>
                    <p class="text-xs font-bold text-slate-400 uppercase tracking-widest mt-0.5">Inventory / Definition</p>
                </div>
            </div>
            <div class="hidden md:flex items-center gap-2 px-4 py-2 bg-indigo-50 text-indigo-700 rounded-xl border border-indigo-100">
                <i class="fa-solid fa-cube text-[10px]"></i>
                <span class="text-[10px] font-black uppercase tracking-wider">Catalog System</span>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="p-8 space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-2">
                                    ...
                                    <div class="relative group">
                                        ...
                                        <input type="text" name="name" required value="{{ old('name') }}" placeholder="e.g. Portland Cement"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative group">
                                        ...
                                        <input type="text" name="unit" required value="{{ old('unit') }}" placeholder="e.g. Bag, Ton, Kg"
                                            class="w-full pl-11 pr-4 py-3.5 bg-slate-50/50 border-slate-100 rounded-2xl text-sm font-medium focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 focus:bg-white transition-all outline-none">
                                    </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative group">
                                        ...
                                        <input type="number" name="price" step="0.01" required value="{{ old('price') }}" placeholder="0.00"
                                            class="w-full pl-11 pr-4 py-3.5 bg-slate-50/50 border-slate-100 rounded-2xl text-sm font-medium focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 focus:bg-white transition-all outline-none">
                                    </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <textarea name="description" rows="5" placeholder="Specify grade, brand preferences, or handling instructions..."
                                    class="w-full px-5 py-4 bg-slate-50/50 border-slate-100 rounded-2xl text-sm font-medium focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 focus:bg-white transition-all outline-none">{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-8">
                    <div class="bg-indigo-600 rounded-[2rem] p-8 text-white space-y-6 shadow-xl shadow-indigo-100">
                        ...
                        <div class="space-y-2">
                            <h4 class="font-bold text-lg">Catalog Note</h4>
                            <p class="text-indigo-100 text-[10px] leading-relaxed font-medium uppercase tracking-wider">
                                Adding a new material allows contractors to select it for site delivery requests and stock consumption reports.
                            </p>
                        </div>
                    ...
                    <div class="bg-white rounded-[2rem] border border-slate-100 p-8">
                        <p class="text-[10px] text-slate-400 font-medium italic text-center">Ensure unit names are consistent across all materials for accurate reporting.</p>
                    </div>
                </div>
            </div>
        </form>
